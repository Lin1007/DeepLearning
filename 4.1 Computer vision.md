...
| :----------------------------------------------: | :------------------------------------------------: |
| <img src='/no_padding_no_strides.gif' width=200> | <img src='/same_padding_no_strides.gif' width=200> |
...
<img src='/padding_strides.gif' width=200>
...
- Define type of pooling:
  ...
  - Average pooling:  slides an (f,f) window over the input and stores the average value of the window in the output.
    ...
    | :--------------------: | :-----------------------: | :--------------------------: |
    | <img src="/pool.jpeg"> | <img src="/maxpool.jpeg"> | <img src="/averagepool.jpg"> |
